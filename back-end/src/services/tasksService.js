...
const getAllTasks = async (userId) => {
  try {
    ...
    throw new Error(
      "Erro ao obter tarefas do banco de dados: " + error.message
    );
  }
};
...
const createTask = async (taskData, userId) => {
  ...
  try {
    ...
    throw new Error(
      "Erro ao criar a tarefa no banco de dados: " + error.message
    );
  }
};
...
const updateTask = async (taskId, updatedData, userId) => {
  ...
  try {
    ...
    throw new Error(
      "Erro ao atualizar a tarefa no banco de dados: " + error.message
    );
  }
};
...
const deleteTask = async (taskId, userId) => {
  ...
  try {
    ...
    throw new Error(
      "Erro ao deletar a tarefa no banco de dados: " + error.message
    );
  }
};
